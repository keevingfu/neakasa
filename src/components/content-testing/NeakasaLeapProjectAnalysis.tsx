...
const NeakasaLeapProjectAnalysis: React.FC = () => {
  ...
  const [selectedPeriod, setSelectedPeriod] = useState<'week1' | 'week2' | 'comparison'>(
    'comparison'
  );
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Comprehensive project tracking and performance analysis
          </p>
        </div>
          ...
          <Card className="p-6">
            ...
            <ResponsiveContainer width="100%" height={350}>
              ...
              >
                ...
                {selectedProduct !== 'steamer' && <Bar dataKey="Litter Box" fill="#F59E0B" />}
              </ComposedChart>
            </ResponsiveContainer>
          </Card>
        </TabsContent>
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 border-l-4 border-green-500 bg-green-50 rounded">
                  ...
                  <p className="text-xs text-gray-600 mt-1">
                    Users prefer official site/Amazon via linktree
                  </p>
                </div>
              </div>
            </Card>
              ...
              <div className="space-y-3">
                <div className="p-3 bg-white rounded-lg">
                  ...
                  <p className="text-sm text-gray-700 mt-1">
                    Despite 11,000 clicks and viral content
                  </p>
                  <div className="mt-2 space-y-1">
                ...
                <div className="p-3 bg-white rounded-lg">
                  ...
                  <p className="text-xs text-gray-600 mt-2">
                    Consider improving CTAs and link placement
                  </p>
                </div>
              </div>
            </Card>
                    ...
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span
                        className={`font-medium ${
                          script.performance === 'High'
                            ? 'text-green-600'
                            : script.performance === 'Low'
                              ? 'text-red-600'
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-600">
                        Anthropomorphic cats using kitchen/bathroom
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-600">
                        Natural integration of litter box in scenes
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-600">
                        Cat health tips with product placement
                      </p>
                    </div>
                  </li>
                </ul>
              ...
              <ul className="space-y-3 text-sm">
                <li className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600">
                      Test accessories and pricing adjustments
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-2">
